            ...
            <el-table
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-tooltip class="item" effect="light" content="修改维修信息">
                            <el-button size="mini" plain type="primary" @click="onEdit(scope.$index)">修改</el-button>
                        </el-tooltip>
                        <el-tooltip class="item" effect="light" content="删除维修信息">
...
<%--                </el-form-item>--%>
                ...
                <el-form-item  label="维修状态" prop="drepairState" required>
                    <el-select v-model="mymodel.drepairState" placeholder="请选择缴纳情况">
...
<%--                    <el-col :span="15">--%>
<%--                        <el-form-item prop='drepairState'>--%>
<%--                            <el-input type="string" v-model="mymodel.drepairState"></el-input>--%>
<%--                        </el-form-item>--%>
<%--                    </el-col>--%>
<%--                </el-form-item>--%>
        ...
        <div class="form">
            ...
            <%--                    :rules="myrulesEdit"--%>
                ...
                <el-form-item label="报修编号" required>
                    <el-col :span="15">
                        <el-form-item prop='repairId'>
                            <el-input type="string" readonly v-model="mymodel.repairId"></el-input>
                        </el-form-item>
                    </el-col>
                </el-form-item>

                <el-form-item label="宿舍号" prop="dormNo" required>
                    <el-select v-model="mymodel.dormNo" readonly placeholder="请选择宿舍号">
                        <el-option label="1-102" value="1-102" readonly></el-option>
                        <el-option label="2-202" value="2-202" readonly></el-option>
                        <el-option label="3-301" value="3-301" readonly></el-option>
                        <el-option label="3-303" value="3-303" readonly></el-option>
                        <el-option label="9-620" value="9-620" readonly></el-option>
                        <el-option label="10-520" value="10-520" readonly></el-option>
                    </el-select>
                </el-form-item>
...
<%--                </el-form-item>--%>
                <el-form-item label="日期" required>
                    <el-col :span="15">
                        <el-form-item prop='drepairData'>
                            <el-input type="data" v-model="mymodel.drepairData"></el-input>
                        </el-form-item>
                    </el-col>
                </el-form-item>
                <el-form-item label="报修内容" required>
                    <el-col :span="15">
                        <el-form-item prop='repairContent'>
                            <el-input type="data" readonly v-model="mymodel.repairContent"></el-input>
                        </el-form-item>
                    </el-col>
                </el-form-item>
...
<script>
    var app = new Vue({
        ...
        methods: {
            ...
            selectData() {
                //通过axios调用服务器json服务
                axios.get("/app/drepair/").then(res => {
            ...
            onEdit(index) {
                ...
                //更新model数据
                this.mymodel = {
                    drepairId: this.tableData[index].drepairId,
                    repairId: this.tableData[index].repairId,
                    dormNo: this.tableData[index].dormNo,
                    drepairData: this.tableData[index].drepairData,
                    repairContent: this.tableData[index].repairContent,
                    drepairState:this.tableData[index].drepairState
                };
                //设置哪行被选中了
            ...
            onDelete(index) {
                this.$confirm('确认删除该数据吗?', '提示', {
                    ...
                    // 删除
                    axios.delete("/app/drepair/" + this.tableData[index].drepairId).then(res => {
                        this.$message("删除成功");
            ...
            onSubmitAdd(myform) {
                //添加,调用post方法
                axios.post("/app/drepair/",this.mymodel).then(res => {
                    // 操作成功
                    this.$message({
                        message: "保存成功！",
                        type: "success"
            ...
            //修改,调用put方法
            onSubmitEdit(myformedit) {

                axios.put("/app/drepair/", this.mymodel).then(res => {
                    // 操作成功
                    this.$message({
                        message: "保存成功！",
                        type: "success"
